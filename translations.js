// Language translations for Leo Recovery website
...
const translations = {
    ru: {
        ...
        // Benefits Section
        benefits: {
            title: "Все инструменты для вашего восстановления",
            card1: "Глубокое понимание",
            card2: "Ментальное становление",
            card3: "Стабильная мотивация"
        },
        ...
        community: {
            ...
            description: "Присоединяйтесь к нашему сообществу в Telegram для получения ежедневной поддержки, мотивации и полезных материалов",
            joinBtn: "Присоединиться"
        },
        
        // Footer
        footer: {
            company: "MELNI APPS, LLC",
            description: "Ваш путь к восстановлению начинается здесь. Вместе мы сильнее.",
        ...
        modals: {
            ...
            privacyTitle: "Политика конфиденциальности сайта",
            close: "×"
        }
    },
    ...
    en: {
        ...
        footer: {
            company: "MELNI APPS, LLC",
            description: "Your path to recovery starts here. Together we are stronger.",
    ...
    es: {
        ...
        hero: {
            logo: "Leo",
            title: "Encuentra Tu Camino Hacia La Recuperación",
            subtitle: "Leo Recovery es una aplicación para quienes buscan apoyo en la superación de adicciones. Rastrea tu progreso, conéctate con una comunidad y recibe recomendaciones personalizadas.",
            downloadBtn: "Descargar en App Store",
            badge: "Disponible en iOS",
            usersLabel: "Usuarios Activos",
            ratingLabel: "Calificación de App Store",
            supportLabel: "Horas de Soporte"
        },
        
        // Solution Section
        solution: {
            title: "Tu Solución Para Superar La Adicción",
            description: "Leo Recovery no es solo una aplicación, sino un sistema integral de apoyo que ayuda a las personas a recuperar el control de sus vidas.",
            list: [
                "Métodos de recuperación basados en evidencia",
                "Soporte 24/7 del asistente de IA Leo GPT",
                "Espacio seguro y confidencial",
                "Comunidad de personas en el camino hacia la recuperación"
            ]
        },
        
        // Benefits Section
        benefits: {
            title: "Todas Las Herramientas Para Tu Recuperación",
            card1: "Comprensión Profunda",
            card2: "Crecimiento Mental",
            card3: "Motivación Estable"
        },
        
        // Features Section
        featuresHeader: {
            description: "Leo Recovery combina los métodos de apoyo más efectivos en una sola aplicación"
        },
        
        features: {
            feature1: {
                title: "Leo GPT — Tu Asistente Personal",
                description: "Asistente de IA que te comprende y está listo para ayudarte en cualquier momento. Basado en métodos científicos de psicoterapia.",
                list: [
                    "Soporte 24/7 sin descansos",
                    "Consejos personalizados",
                    "Conversaciones confidenciales",
                    "Enfoque empático y comprensivo"
                ]
            },
            feature2: {
                title: "Rastreador de Recuperación",
                description: "Rastrea tu progreso día a día. Visualizar los logros te motiva a continuar en tu camino de recuperación.",
                list: [
            ...
            feature3: {
                title: "Diario de Sentimientos",
                description: "Explora tus emociones y pensamientos. El diario estructurado ayuda a comprender los desencadenantes y patrones de comportamiento.",
                list: [
                    "Entradas estructuradas",
                    "Análisis de emociones y desencadenantes",
                    "Integración con Leo GPT",
                    "Privacidad y confidencialidad"
                ]
            },
            feature4: {
                title: "Cursos Educativos",
                description: "Programas de aprendizaje estructurados basados en métodos probados de logoterapia y terapia cognitivo-conductual.",
                list: [
                    "Curso \"La Adicción Como Problema\"",
                    "Programa de \"Codependencia\"",
                    "Lecciones paso a paso con práctica",
                    "Sistema de progreso y logros"
                ]
            },
            feature5: {
                title: "Feed de Conocimientos",
                description: "Artículos útiles, historias de recuperación y materiales de expertos para apoyar tu camino hacia la libertad.",
                list: [
            ...
            feature6: {
                ...
                description: "Prácticas interactivas para desarrollar la autoconciencia, la regulación emocional y superar los desencadenantes.",
                list: [
                    "Glosario de terminología temática",
            ...
            feature8: {
                ...
                description: "Conéctate con personas que te comprenden. Comparte experiencias, recibe apoyo e inspiración.",
                list: [
                    "Espacio seguro de comunicación",
                    "Historias de éxito de personas reales",
                    "Apoyo mutuo y motivación",
                    "Moderación y confidencialidad"
                ]
            }
        },
        ...
        timeline: {
            ...
            description: "Únete a miles de personas que ya están dando pasos hacia una vida mejor",
            step1: "Reconocimiento del Problema",
            step2: "Búsqueda de Ayuda",
            step3: "Integración de Nuevos Conocimientos",
            downloadBtn: "Descargar en App Store"
        },
        ...
        footer: {
            company: "MELNI APPS, LLC",
            description: "Tu camino hacia la recuperación comienza aquí. Juntos somos más fuertes.",
        ...
        // Modals
        modals: {
            aboutTitle: "Acerca de la Empresa",
            privacyTitle: "Política de Privacidad del Sitio Web",
            close: "×"
        }
    }
};
...
const imagePaths = {
    ...
    es: {
        mockups: {
            feature1: 'assets/espanMocups/dialogWithLeoGPT_es.png',
            feature2: 'assets/espanMocups/recoveryTracker_es.png',
            feature3: 'assets/espanMocups/diaryMain_es.png',
            feature4: 'assets/espanMocups/addictionCourse_es.png',
            feature5: 'assets/espanMocups/leoFeed_es.png',
            feature6: 'assets/espanMocups/practice_es.png',
            feature8: 'assets/espanMocups/realStories_es.png'
            // feature7 (Rehabs) not included for ES
        },
        backgrounds: {
